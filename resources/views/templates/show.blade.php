        ...
        <div class="neon-card p-4" style="border-color: rgba(57,255,20,0.2);">
            ...
            @if($canForge)
                ...
                <form action="{{ route('cards.forge', $template) }}" method="POST">
                    @csrf
                    <button type="submit" class="btn btn-neon-lime" id="btn-forge-card" data-confirm="Forge a new Digital Card for {{ config('diamonds.costs.forging') }} Diamonds? You can forge up to 3 cards per day from this template.">
