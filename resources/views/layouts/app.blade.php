            ...
            @if($currentRoomInfo)
                <a href="{{ $currentRoomInfo['type'] === '1v1' ? route('battles.room', $currentRoomInfo['battle']->id) : route('team-battles.room', $currentRoomInfo['battle']->id) }}" 
                   ...
                   style="position: fixed; bottom: 30px; right: 30px; border-radius: 50%; width: 65px; height: 65px; display: flex; align-items: center; justify-content: center; z-index: 1050; padding: 0; background: rgba(10, 10, 30, 0.9); box-shadow: 0 0 20px rgba(0, 240, 255, 0.6); animation: pulse-fab 2s infinite;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 512 512" style="color: #00f0ff; filter: drop-shadow(0 0 5px #00f0ff);">
                        <path d="M495.9 16.6c-4.3-4.3-10.9-6-16.7-4.4L372.4 41.5 329.1 84.8 352 107.7 304.5 155.3l-59-59c-6.2-6.2-16.4-6.2-22.6 0l-14.1 14.1c-6.2 6.2-6.2 16.4 0 22.6l59 59L220.3 239.5l-59-59c-6.2-6.2-16.4-6.2-22.6 0l-14.1 14.1c-6.2 6.2-6.2 16.4 0 22.6l59 59L160.7 299.1l-59-59c-6.2-6.2-16.4-6.2-22.6 0L65 254.2c-6.2 6.2-6.2 16.4 0 22.6l59 59-47.5 47.5L53.7 360.5c-6.2-6.2-16.4-6.2-22.6 0l-14.1 14.1c-6.2 6.2-6.2 16.4 0 22.6l22.9 22.9L16.6 443.4c-8.8 8.8-8.8 23.2 0 32l20 20c8.8 8.8 23.2 8.8 32 0l23.3-23.3 22.9 22.9c6.2 6.2 16.4 6.2 22.6 0l14.1-14.1c6.2-6.2 6.2-16.4 0-22.6L128.5 415.4l22.9-22.9 47.5-47.5 59 59c6.2 6.2 16.4 6.2 22.6 0l14.1-14.1c6.2-6.2 6.2-16.4 0-22.6l-59-59 22.8-22.8 59 59c6.2 6.2 16.4 6.2 22.6 0l14.1-14.1c6.2-6.2 6.2-16.4 0-22.6l-59-59 47.5-47.5 59 59c6.2 6.2 16.4 6.2 22.6 0l14.1-14.1c6.2-6.2 6.2-16.4 0-22.6l-59-59 47.5-47.5 22.9 22.9c6.2 6.2 16.4 6.2 22.6 0l14.1-14.1c6.2-6.2 6.2-16.4 0-22.6l-22.9-22.9L499.8 106.8c1.6-5.8-.1-12.4-3.9-16.7zm-278.4 207l-35.3-35.3 47.5-47.5 35.3 35.3-47.5 47.5zm70.3-70.3l-35.3-35.3 47.5-47.5 35.3 35.3-47.5 47.5zM425.4 78l-35.3-35.3 47.5-47.5 35.3 35.3-47.5 47.5z"/>
                    </svg>
                </a>
                <style>
                    @keyframes pulse-fab {
