    ...
    <div class="card bg-dark border-info rounded-4 p-4 mb-4" style="background: rgba(10, 10, 30, 0.8);">
        <form action="{{ route('admin.cards.index') }}" method="GET" class="d-flex gap-2">
            <div class="flex-grow-1">
                <input type="text" name="search" class="form-control bg-dark text-white border-info" placeholder="Search by Card ID, Owner Username, or Template Name" value="{{ request('search') }}">
            </div>
