...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-secondary lead mb-0">Create a new diamond purchasing package.</p>
        </div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card bg-dark bg-opacity-75 border-info rounded-4 p-4 shadow-lg" style="backdrop-filter: blur(10px);">
                <div class="card-body">
                    <form action="{{ route('admin.diamond-packages.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-4">
                                ...
                                <input type="text" name="name" id="name" class="form-control form-control-lg bg-dark text-white border-info @error('name') is-invalid @enderror" value="{{ old('name') }}" required autofocus placeholder="e.g. Starter Pack">
                                @error('name')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="number" name="diamonds" id="diamonds" class="form-control form-control-lg bg-dark text-white border-info @error('diamonds') is-invalid @enderror" value="{{ old('diamonds') }}" required min="1">
                                @error('diamonds')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" name="currency" id="currency" class="form-control form-control-lg bg-dark text-white border-info @error('currency') is-invalid @enderror" value="{{ old('currency', 'PHP') }}" required>
                                @error('currency')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="number" step="0.01" name="price" id="price" class="form-control form-control-lg bg-dark text-white border-info @error('price') is-invalid @enderror" value="{{ old('price') }}" required min="0">
                                @error('price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="number" step="0.01" name="promo_price" id="promo_price" class="form-control form-control-lg bg-dark text-white border-info @error('promo_price') is-invalid @enderror" value="{{ old('promo_price') }}" min="0">
                                @error('promo_price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-4">
                                <div class="form-check form-switch custom-switch">
                                    <input class="form-check-input bg-dark border-info" type="checkbox" name="is_active" id="is_active" checked value="1">
                                    <label class="form-check-label text-white small text-uppercase fw-bold" for="is_active">Active Package</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-check form-switch custom-switch">
                                    <input class="form-check-input bg-dark border-info" type="checkbox" name="allow_hitpay" id="allow_hitpay" checked value="1">
                                    <label class="form-check-label text-white small text-uppercase fw-bold" for="allow_hitpay">Allow HitPay</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-check form-switch custom-switch">
                                    <input class="form-check-input bg-dark border-info" type="checkbox" name="allow_manual" id="allow_manual" checked value="1">
