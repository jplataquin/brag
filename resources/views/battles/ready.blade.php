    ...
    <div class="col-lg-5">
        ...
        <div class="text-center">
            <x-digital-card 
                ...
                :imagePositionY="$challengerCard->template->image_position_y ?? 50"
                :wins="$challengerCard->wins"
                :losses="$challengerCard->losses"
                :lifePoints="$challengerCard->life_points"
                :integrityStat="$challengerCard->integrity_stat"
                :status="$challengerCard->status"
