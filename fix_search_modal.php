...
$html = preg_replace('/<label class="form-label">MARSHALL USERNAME<\/label>.*?<div class="modal-footer border-0 pt-0">\s*<button type="button" class="btn btn-neon w-100" style="border-color: #ffdd00; color: #ffdd00;" data-bs-dismiss="modal">ELECT USER<\/button>\s*<\/div>/s', $marshallModalHtml, $html);
